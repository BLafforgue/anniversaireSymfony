 ...
 */
final class Version20240229151615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `member` CHANGE user_id_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `member` CHANGE user_id user_id_id INT NOT NULL');
    }
}
